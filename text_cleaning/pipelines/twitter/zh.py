...
class TwitterMandarinTextCleaningPipeline(TextCleaningPipeline):
    ...
    def __init__(self,
        ...
        super().__init__(
            ...
            logger=logger,
            debug=debug)
        self.trad2simp = trad2simp
        if trad2simp:
            self.functions.append(text_fx.TraditionalToSimplified())


class TwitterMandarinTokensCleaningPipeline(TokensCleaningPipeline):
